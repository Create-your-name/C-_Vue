...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseOracle("Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=10.163.80.13)(PORT=1521))(CONNECT_DATA=(SERVICE_NAME=ORCL)));User Id=rxmesuser;Password=rxmesuser;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Taskid).HasName("BPMI_TASK2PK");

            entity.ToTable("BPMI_TASK", "RXBPM");

            entity.HasIndex(e => e.Processid, "BPMI_TASKP1ID");
        ...
        {
            entity.HasKey(e => e.Tokenid).HasName("BPMI_TLPK");

            entity.ToTable("BPMI_TOKENLAST", "RXBPM");

            entity.HasIndex(e => new { e.Actorid, e.Taskid }, "BPMI_TOKENLASTTASKID11ID");

            entity.HasIndex(e => e.Receivetime, "PKSDS");

            entity.HasIndex(e => e.Inituserid, "PPINITID");
        ...
        modelBuilder.Entity<RxFormProductUnusual>(entity =>
        {
            ...
            entity.Property(e => e.Zrbm1)
                .HasMaxLength(100)
                .IsUnicode(false)
                .HasColumnName("ZRBM1");
            entity.Property(e => e.Zrbm1Bf)
                .HasMaxLength(100)
                .IsUnicode(false)
                .HasColumnName("ZRBM1_BF");
            entity.Property(e => e.Zrbm1Fg)
                .HasMaxLength(100)
                .IsUnicode(false)
                .HasColumnName("ZRBM1_FG");
            entity.Property(e => e.Zrbm1Ycfx)
                .HasMaxLength(100)
                .IsUnicode(false)
                .HasColumnName("ZRBM1_YCFX");
            entity.Property(e => e.Zrbm1Yyldl)
                .HasMaxLength(100)
                .IsUnicode(false)
                .HasColumnName("ZRBM1_YYLDL");
            entity.Property(e => e.Zrbm1Zcfx)
                .HasMaxLength(100)
                .IsUnicode(false)
                .HasColumnName("ZRBM1_ZCFX");
            entity.Property(e => e.Zrbm2)
                .HasMaxLength(100)
                .IsUnicode(false)
                .HasColumnName("ZRBM2");
            entity.Property(e => e.Zrbm2Bf)
                .HasMaxLength(100)
                .IsUnicode(false)
                .HasColumnName("ZRBM2_BF");
            entity.Property(e => e.Zrbm2Fg)
                .HasMaxLength(100)
                .IsUnicode(false)
                .HasColumnName("ZRBM2_FG");
            entity.Property(e => e.Zrbm2Ycfx)
                .HasMaxLength(100)
                .IsUnicode(false)
                .HasColumnName("ZRBM2_YCFX");
            entity.Property(e => e.Zrbm2Yyldl)
                .HasMaxLength(100)
                .IsUnicode(false)
                .HasColumnName("ZRBM2_YYLDL");
            entity.Property(e => e.Zrbm2Zcfx)
                .HasMaxLength(100)
                .IsUnicode(false)
                .HasColumnName("ZRBM2_ZCFX");
